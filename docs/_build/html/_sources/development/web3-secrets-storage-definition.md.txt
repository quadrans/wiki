...
To make your app work on Quadrans, you can use the web3 object provided by the web3.js library. Under the hood it communicates to a local node through RPC calls. [web3](https://github.com/ChainSafe/web3.js) works with any Quadrans node, which exposes an RPC layer.
