        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex">
                ...
                <div class="card-body flex-fill">
                    ...
                    <p class="card-text">Installation guides, management informations and much more aboutt Quadrans Nodes.</p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex">
                <div class="card card-q text-center intro-card shadow">
                <img src="_static/images/icons/icn_programming_violet.png" class="card-img-top" alt="icon">
                <div class="card-body flex-fill">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex">
                ...
                <div class="card-body flex-fill">
                    ...
                    <p class="card-text">Projects related to Quadrans Foundation and its partners.</p>
                     <div class="text-center">
                        <a href="projects/">
                           <button class="fill disabled">Read More</button>
                        </a>
