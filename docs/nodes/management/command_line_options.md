...
gqdc --help
NAME:
	gqdc - the go-ethereum command line interface
...
QUADRANS OPTIONS:
	...
	--datadir "/home/user/data_directory"   Data directory for the databases and keystore
...
MISC OPTIONS:
	...
	--ethash.dagdir "/home/user/.ethash"        Directory to store the ethash mining DAGs (default = inside home folder)
